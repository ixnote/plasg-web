...
const ScrollToTopButton = () => {
  ...
  return (
    <>
      <div className="fixed bottom-5 right-0 z-50 flex items-center justify-center gap-4 px-[16px] py-[8px] font-geistsans text-base font-normal text-[#CDE399] lg:right-5">
        <button
