      ...
      <div className="flex flex-col gap-12 pb-12 lg:gap-20">
        ...
        {/* <div className="flex flex-col gap-4 lg:gap-8">
          <SubsectionHeader
            left={""}
            right={
              "Arch. Samuel Jatau (born 12 March 1965) is a Nigerian lawyer and politician who is the current governor of Plateau State since 2023. He is a former Chairman of Mangu Local Government Area of Plateau State. Mutfwang was sworn in as governor on 29 May 2023."
            }
            body
          />
          <SubsectionHeader
...
export default SecretaryBiography;
