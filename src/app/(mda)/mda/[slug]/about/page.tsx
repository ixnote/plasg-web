...
const About = () => {
  ...
  console.log("🚀 ~ About ~ oneMda:", oneMda);
    ...
    <>
      <div className="min-h-screen max-w-[2040px] pb-[96px] relative flex items-center justify-center bg-cover bg-center bg-no-repeat">
        <div className="m-auto w-[92%] flex justify-between flex-col gap-8">
          {/* About Hero */}
          <div className="bg-brand-white flex flex-col py-24 pt-[120px] gap-4 lg:gap-16">
            <div className="flex flex-col items-center justify-center gap-8 mb-10">
              <p className="text-[52px] flex items-center justify-center text-brand-main font-medium font-geistsans max-w-[800px] leading-[56px]">
                About
              </p>
              <div className="w-[50%] flex items-center justify-center font-geistsans font-normal text-lg text-brand-dark/70">
      ...
      <div className='w-full mx-auto bg-brand-white 2xl:max-w-7xl"'>
        <div
          ...
          style={{ backgroundImage: `url(${oneMda?.about?.image})` }}
        >
        ...
        <div className=" h-[468px] w-full mt-32  flex justify-between p-14 mb-28  ">
          ...
          <div className="w-[50%] h-[350px]-[Geist] font-normal size-[10px] leading-[28px]">
            <p>
              ...
              control over the investments made and that will continue to be
              made in ICT and to achieve a solid foundation through ICT
              infrastructure architecture, systems design and work processes
              which will continue to support a robust ICT facility throughout
              the State. In the long-term, these policies will greatly assist
              the ease with which PICTDA can react to new challenges and adopt
              new technologies aimed at increasing efficiencies and create
              positive impacts for all PLSG stakeholders.{" "}
            </p>
            <p className="mt-8">
              {" "}
              PICTDA shall develop policies, standards, guidelines, and
              frameworks as well as capabilities, skillsets, and resources that
              will add strategic value and increase business productivity within
              Plateau State Government and the entire state.
            </p>
          </div>
        </div>
