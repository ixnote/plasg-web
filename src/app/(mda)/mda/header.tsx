...
const Header = ({ propSlug }: any) => {
  console.log("🚀 ~ Header ~ propSlug:", propSlug);
  ...
  useEffect(() => {
    setAboutPath(`/mda/${mdaSlug || propSlug}/about`);
    setLibraryPath(`/mda/${mdaSlug || propSlug}/library`);
    setContactPath(`/mda/${mdaSlug || propSlug}/contact`);
  }, [mdaSlug, propSlug]);
