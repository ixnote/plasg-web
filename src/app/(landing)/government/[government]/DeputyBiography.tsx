    ...
    <>
      <div className="flex flex-col gap-12 pb-12 lg:gap-20">
        <SubsectionHeader
          left={"BIOGRAPHY"}
          right={
            "Meet Mrs. Josephine Piyo: A Beacon of Leadership for Plateau State"
          }
        />
        <div className="flex flex-col gap-4 lg:gap-8">
          <SubsectionHeader
            left={""}
            right={
              "Josephine Piyo (born 12 March 1965) is a Nigerian lawyer and politician who is the current governor of Plateau State since 2023. He is a former Chairman of Mangu Local Government Area of Plateau State. Mutfwang was sworn in as governor on 29 May 2023."
            }
            body
          />
          <SubsectionHeader
