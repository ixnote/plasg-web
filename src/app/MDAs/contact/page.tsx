    ...
    return (
      <div className='w-full'>
        ...
        <div className="w-full h-[1030px] p-9">
            <div 
                className='w-full bg-cover bg-center h-[720px] pt-8'
                style={{ backgroundImage: `url(${bg.src})` }}
            >
               <div className="flex justify-center  h-[646px]">
                <div className="h-[438px] w-[682px] gap-20 my-28">
                    <div className="h-full w-full ">
                        <header className="w-[100px] h-[40px] flex justify-center items-center  border-white border-2 text-white  font-normal leading-3 size-4 font-[Geist] rounded-md mb-1">Contact</header>
                        <p className=" w-[520px] h-[100px] flex justify-start items-center text-white font-[Geist] text-4xl size-10 font-medium leading-[20px]">Need help? Contact us</p>
                        <p className='text-white py-8 font-[Geist] font-normal text-xl'>Having an issue or you just need help? Contact us with your inquiries via:</p>
                            <div className=' '>
                                <div className="text-white flex w-full py-7 ">
                                <Image src={location} alt=""/>
                                <div className='px-6'>
                                  <p className="text-white">Office Of The Executive Governor, Plateau State Government House, Little Rayfield, Jos Plateau State</p>
                                </div> 
                                </div>  
                             <div  className='flex justify-between h-[64px] w-[600px] '>
                                ...
                                <div className='flex items-center justify-between w-[260px] '>
                                    ...
                                    <a href="pictda@plateaustate.gov.ng" className="text-white">pictda@plateaustate.gov.ng</a>
                                </div>
                             </div>
                        </div>
                    </div>  
