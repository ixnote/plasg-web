...
import Filter from '@/app/(landing)/resource/Filter';
...
const Library= () => {
    return (
      <div className='w-full '>
        ...
        <div className=" mt-20 h-[144px]  w-full flex flex-col items-center  pb-52 ">
        <div className="w-[800px] h-[56px] flex justify-center  font-semibold font-[Geist] size-[52px] text-3xl text-[#0E3E40]">
            ...
            <p>Welcome to our comprehensive Library, the ultimate hub for all services, resources, and documents provided by PICTDA </p>
            </div>
        </div>
        <div className='h-[3670] pb-48 w-full'>
            <div className=''>
                <Filter
